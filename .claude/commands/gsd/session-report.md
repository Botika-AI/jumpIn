...
<execution_context>
@D:/!programming/botika/jumpInLoginAndQrCode/.claude/get-shit-done/workflows/session-report.md
</execution_context>

<process>
Execute the session-report workflow from @D:/!programming/botika/jumpInLoginAndQrCode/.claude/get-shit-done/workflows/session-report.md end-to-end.
</process>
