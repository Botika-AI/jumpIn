...
Reference full template: `D:/!programming/botika/jumpInLoginAndQrCode/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `D:/!programming/botika/jumpInLoginAndQrCode/.claude/get-shit-done/templates/state.md`.
