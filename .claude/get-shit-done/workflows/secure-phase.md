...
```
Agent(
  prompt="Read /Users/danielegazzosi/Desktop/Jump'In Platform/jumpIn/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/danielegazzosi/Desktop/Jump'In Platform/jumpIn/.claude/get-shit-done/templates/SECURITY.md`
