...
- **Global scope**: `/Users/danielegazzosi/Desktop/Jump'In Platform/jumpIn/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/danielegazzosi/Desktop/Jump'In Platform/jumpIn/.claude/notes/`)
...
2. Glob `/Users/danielegazzosi/Desktop/Jump'In Platform/jumpIn/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/danielegazzosi/Desktop/Jump'In Platform/jumpIn/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/danielegazzosi/Desktop/Jump'In Platform/jumpIn/.claude/notes/` — works in any directory
