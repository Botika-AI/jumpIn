...
- **Global scope**: `D:/!programming/botika/jumpInLoginAndQrCode/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `D:/!programming/botika/jumpInLoginAndQrCode/.claude/notes/`)
...
2. Glob `D:/!programming/botika/jumpInLoginAndQrCode/.claude/notes/*.md` (if directory exists) — global notes
...
Global (D:/!programming/botika/jumpInLoginAndQrCode/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `D:/!programming/botika/jumpInLoginAndQrCode/.claude/notes/` — works in any directory
