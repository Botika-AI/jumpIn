...
```bash
INIT=$(node "/Users/danielegazzosi/Desktop/Jump'In Platform/jumpIn/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/Users/danielegazzosi/Desktop/Jump'In Platform/jumpIn/.claude/get-shit-done/templates/spec.md.
