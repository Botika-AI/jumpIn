...
INSTALL_JS_GLOBAL="/Users/danielegazzosi/Desktop/Jump'In Platform/jumpIn/.claude/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /Users/danielegazzosi/Desktop/Jump'In Platform/jumpIn/.claude/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
