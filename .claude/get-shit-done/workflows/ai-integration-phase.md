...
<required_reading>
@/Users/danielegazzosi/Desktop/Jump'In Platform/jumpIn/.claude/get-shit-done/references/ai-frameworks.md
@/Users/danielegazzosi/Desktop/Jump'In Platform/jumpIn/.claude/get-shit-done/references/ai-evals.md
</required_reading>
...
```markdown
Read /Users/danielegazzosi/Desktop/Jump'In Platform/jumpIn/.claude/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/Users/danielegazzosi/Desktop/Jump'In Platform/jumpIn/.claude/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /Users/danielegazzosi/Desktop/Jump'In Platform/jumpIn/.claude/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /Users/danielegazzosi/Desktop/Jump'In Platform/jumpIn/.claude/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /Users/danielegazzosi/Desktop/Jump'In Platform/jumpIn/.claude/agents/gsd-eval-planner.md for instructions.
