...
```bash
INIT=$(node "/Users/danielegazzosi/Desktop/Jump'In Platform/jumpIn/.claude/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/Users/danielegazzosi/Desktop/Jump'In Platform/jumpIn/.claude/get-shit-done/bin/gsd-tools.cjs" commit \
