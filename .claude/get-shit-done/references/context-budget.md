...
The keys live in `.claude/settings.json` (project) or `/Users/danielegazzosi/Desktop/Jump'In Platform/jumpIn/.claude/settings.json` (global) — **not** in `.planning/config.json`:
